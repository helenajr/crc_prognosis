...
Summarise numbers of samples of each type in the dataset. We are only interested in 'Primary tumor'(which comes from the TCGA dataset) and 'Normal Tissue' (GTex) for the following analyses. 
